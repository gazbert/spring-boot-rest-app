package com.gazbert.restsample.api.v1.config;
...
import com.gazbert.restsample.api.v1.AbstractControllerTest;
import com.gazbert.restsample.domain.MarketConfig;
import com.gazbert.restsample.services.MarketConfigService;
...
@SpringBootTest
@WebAppConfiguration
public class TestMarketConfigController extends AbstractControllerTest {
  ...
  public void testUpdateMarketConfigWithAdminTokenAuthorized() throws Exception {
    ...
    verify(marketConfigService, times(1)).updateMarketConfig(ArgumentMatchers.any());
  }
  ...
  public void testUpdateMarketConfigWithUserTokenForbidden() throws Exception {
    ...
    verify(marketConfigService, times(0)).updateMarketConfig(ArgumentMatchers.any());
  }
  ...
  public void testCreateMarketConfigWithAdminTokenAuthorized() throws Exception {
    ...
    verify(marketConfigService, times(1)).createMarketConfig(ArgumentMatchers.any());
  }
  ...
  public void testCreateMarketConfigWithAdminTokenForbidden() throws Exception {
    ...
    verify(marketConfigService, times(0)).createMarketConfig(ArgumentMatchers.any());
  }
